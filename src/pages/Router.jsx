...
import SnackProduct from './Product/SnackProduct'
import BitaProduct from "./Product/BitaProduct";
    ...
    <>
      {isInLogged ? (
        <Routes>
          ...
          <Route path="/product/snack" element={<SnackProduct />} />
          <Route path="/product/bita" element={<BitaProduct />} />
