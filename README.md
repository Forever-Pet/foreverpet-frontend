...
그래서 오랜 시간을 함께 할 반려 동물을 위한 친환경 , 비건 제품 등을 판매하여 소비자들 즉, 반려 동물에게 전해짐으로써 펫 케어를 위한 서비스를 제공 해 주는 웹 사이트를 개발 하였습니다.
...
- 은하 : 메인 홈 ( 인증 상태에 따라 화면 분기 , 상품 title 전달 , 상품 랜덤 호출 ) , 캐러셀 , 검색 기능 담당   
